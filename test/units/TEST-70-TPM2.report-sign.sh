...
at_exit() {
    set +e
    # Evict any persistent objects the tests may have left behind.
    tpm2_evictcontrol -C o -c "$PERSISTENT_HANDLE" >/dev/null 2>&1
    tpm2_evictcontrol -C o -c "$PARENT_HANDLE" >/dev/null 2>&1
...
test_list_keys_primary_unavailable() {
    ...
    local template="00180023000b00050072000000100018000b0003001000000000"
